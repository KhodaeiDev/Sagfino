...
const PersonalInformation: React.FC<{ userInfos: UserInfos }> = ({
  ...
  return (
    <>
      <div className="  flex gap-x-10    w-fit h-fit  border border-gray-D9 rounded-2xl p-3 lg:p-6  ">
        {/* content right */}
        ...
        <div className="col-span-9  grid-flow-col   ">
          ...
          <button
            onClick={openModal}
            className="  transition-all duration-300 hover:opacity-80  cursor-pointer  mt-2  py-2 px-5 sm:px-15  center  text-white bg-primary  text-xs lg:text-sm font-shabnamMedium rounded-sm  lg:rounded-lg "
          >
            اطلاعات تماس
          </button>
        </div>
